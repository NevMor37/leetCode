...
public class FixChain {
 ...
 String file;
    ...
    public FixChain(ArrayList<Vertex> Vertices, ArrayList<graphEdge> Edges, ArrayList<functionnode> VNFs,String file, int BW) {
    ...
    public int mappingDFS(){
        ...
        System.out.println("Priority list for DFS : " + priorityDFS);
        ...
        findShortestPath SP_DFS=new findShortestPath(Vertices, Edges, VNFs);
        ...
        for (Integer r : keys) {
            if (treemap.get(r).isEmpty()){                
                System.out.println("***********************No candidate for this functionality ***********************************");
                flagTop=false;
            }
