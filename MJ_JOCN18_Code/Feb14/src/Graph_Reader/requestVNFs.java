...
//    }
    ...
    public int [][] createRequest(int a){ //generate dep matrix a*a
        ...
        for (int i = 0; i < VNFs.size(); i++) {
            ...
            System.out.println("VNF number: " + VNFs.get(i).getNumber() + "  Get Func Dep : " + VNFs.get(i).getFuncDep());
        }
        ...
        for (int i = 0; i < VNFs.size(); i++) {
            ...
            System.out.println("No dependency for node: " + VNFs.get(i).getNumber()); //So make the corresponding row equal to the zero
                for (int j = 0; j < matrixRequest[VNFs.get(i).getNumber()].length; j++) {  //If there is no dep the corresponding col should be zero 
...
//     int CPU=10;
    ...
    matrixRequest=rd.readfiles("outhere22.txt");
        ...
        for (int i = 0; i < 1749; i++) {
            ...
            for (int k = 0; k < copiesofDep1.size(); k++) {
                wr.writeFile(copiesofDep1.get(k),count);
 ...
 /*   ArrayList<int[][]> copiesofDepBackup = new ArrayList<int[][]>();
     for (int i = 0; i < copiesofDep.size(); i++) {
      int[][] a=copiesofDep.get(i);

        for (int m1 = 0; m1 < a.length; m1++) {
                 for (int n1 = 0; n1 < a[m1].length; n1++) {                   
                     System.out.print(a[m1][n1] + " ");    
                             }
                          System.out.println("");               
                               }
      boolean found=false;
        for (int j = i+1; j < copiesofDep.size(); j++) {
            int[][] b=copiesofDep.get(j);
           if(equal(a, b)){
               found=true;
               System.out.println("The equals are: " + "i " + i + " j" + j );
                for (int m1 = 0; m1 < a.length; m1++) {
                for (int n1 = 0; n1 < a[m1].length; n1++) {                   
                    System.out.print(a[m1][n1] + " ");    
                            }
            ...
            for (int m1 = 0; m1 < b.length; m1++) {
                        for (int n1 = 0; n1 < b[m1].length; n1++) {                   
                            System.out.print(b[m1][n1] + " ");    
                                    }
                                 System.out.println("");                                                    }
           } 
        }
...
/*         for (int j = 0; j < copiesofDep.size(); j++) {
      ...
      //  matrixRequest=rd.readfiles("outhere22.txt");
       ...
       // int [][] matrixDepBack;
        //int numberOfNodesBack=matrixRequest[i].length;
  ...
  ///////////////////////////////////////////////////////// 
        ...
        System.out.println("******************************************************************");       
        System.out.println("The service request read from file: " + fileName);
       ...
       // newVer.setNumber(t);
        ...
        for (int i = 0; i < allVNFs.size(); i++) {
              System.out.println("VNF number: " + allVNFs.get(i).getNumber()+ " Requ CPU: " + allVNFs.get(i).getReqCPU());            
        }      
        System.out.println("******************************************************************");
        ...
        /////////////////////////////////////////////////
            public ArrayList<Integer> getDependentsMatrix(int node,int [][] matrix1 ){ //Passing the node number and get its dependents 
        //////////////////////////////////////////////////////////////////////////Connections for each vertex
       ...
       // System.out.println("For node: " + node + " The children/Dependents are: " + neighbours);   
