...
//Here I received a list of candidate nodes that we want to check to see which one is closesst to the latest mapped node
//For example the substrate list {2,3,5,6,11}, and the latest used substrate node that was used for mapping 0
// so we find the shortest distance between  (0,2),(0,3)(0,5)(0,6)(0,11), which is as folloing:
