...
public class AlgoRPS {
	...
	public void nodeMapping(String sFilename, int[] request) {
		...
		double totalReliability = findReliability(constructedTree);
	...
	private double findReliability(List<Vertex> constructedTree) {
...
//		}
		...
		List<Vertex> sortedList = sortObj.sortList(neighbors);
		
		highestNeighbors = sortedList.get(0);
